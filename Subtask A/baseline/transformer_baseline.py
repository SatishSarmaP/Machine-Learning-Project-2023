...
if __name__ == '__main__':
    ...
    model = "C:/Users/satis/Documents/GWU Fall Sem 2023/Machine Learning/Project/Subtask A/subtaskA/xlm-roberta-base/subtaskA/0/checkpoint-5988"
 # For example 'xlm-roberta-base'
...
#python subtaskA/baseline/transformer_baseline.py --train_file_path subtaskA/MonolingualTrack/subtaskA/data/A_train_monolingual.jsonl --test_file_path subtaskA/MonolingualTrack/subtaskA/data/A_dev_monolingual.jsonl --prediction_file_path subtaskA/MonolingualTrack/subtaskA/data/A_perdiction_monolingual.jsonl --subtask A
#python subtaskA/baseline/transformer_baseline.py --train_file_path subtaskA/MultilingualTrack/subtaskA/data/A_train_multilingual.jsonl --test_file_path subtaskA/MultilingualTrack/subtaskA/data/A_dev_multilingual.jsonl --prediction_file_path subtaskA/MultilingualTrack/subtaskA/data/A_perdiction_multilingual.jsonl --subtask A