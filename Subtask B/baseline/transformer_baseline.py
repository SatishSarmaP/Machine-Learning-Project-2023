...
def fine_tune(train_df, valid_df, checkpoints_path, id2label, label2id, model):
    ...
    tokenizer = AutoTokenizer.from_pretrained(model,ignore_mismatched_sizes=True)     # put your model here
...
#python subtaskB/baseline/transformer_baseline.py --train_file_path subtaskB/subtaskB/data/B_train.jsonl --test_file_path subtaskB/subtaskB/data/B_dev.jsonl --prediction_file_path subtaskB/subtaskB/data/B_perdiction.jsonl --subtask B